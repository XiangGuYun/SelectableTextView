...
public class SelectableTextHelper {
    ...
    public SelectableTextHelper(Builder builder) {
        ...
        init(builder.windowViewId);
    }

    private void init(int windowViewId) {
        ...
        mOperateWindow = new OperateWindow(mContext, windowViewId);
    }
    ...
    public void doCopy(OnCopyed onCopyed){
    ...
    public void doSelectAll(OnSelected selected){
        hideSelectView();
        ...
        showCursorHandle(mEndHandle);
        mOperateWindow.show();
        selected.select(mTextView.getText().toString());
    }
    ...
    private class OperateWindow {
        ...
        public OperateWindow(final Context context, int windowViewId) {
            contentView = LayoutInflater.from(context).inflate(windowViewId, null);
    ...
    public static class Builder {
        ...
        private int windowViewId;

        public Builder(TextView textView, int windowViewId) {
            mTextView = textView;
            this.windowViewId = windowViewId;
        }
